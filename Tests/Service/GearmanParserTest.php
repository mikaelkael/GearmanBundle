...
use Mkk\GearmanBundle\Service\GearmanParser;
...
class GearmanParserTest extends WebTestCase
{
    ...
    public function testGearmanParserLoadFromContainer()
    {
        ...
        $this->assertInstanceOf(
            '\Mkk\GearmanBundle\Service\GearmanParser',
            static::$kernel
                ->getContainer()
                ->get('gearman.parser')
        );
    ...
    public function testGetFileClassNamespaceSingle()
    {
        ...
        $this->assertEquals(
            'Mkk\GearmanBundle\Tests\Service\Mocks\SingleCleanFile',
    ...
    public function testGetFileClassNamespaceCommented()
    {
        ...
        $this->assertEquals(
            'Mkk\GearmanBundle\Tests\Service\Mocks\SingleCommentedFile',
            $gearmanParser->getFileClassNamespace($mockNamespace)
        );
    }
